(function () {
    ...
    // the following namespace will be used to complete all click events on the func.html page
    var _choosen_func = "";
    ...
    WinJS.Namespace.define('clicked_me', {
        ...
        //at the bottem of the func.html page
        clicked: function (me) {          
            ...
            server.func_sub(updated_answer);
        },
        next_page: function () {
